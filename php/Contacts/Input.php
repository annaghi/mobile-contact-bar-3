    ...
    public function sanitize( $contacts = [] )
    {
        ...
        foreach ( $contacts as $contact_key => $contact )
        {
            ...
            {  
                ...
                {
                    $sanitized_contact['custom'][$custom_key][$setting_key] = abmcb( Settings\Input::class )->sanitize_color( $setting );
                }
            }
